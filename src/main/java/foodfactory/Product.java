 ...
 * different implementations of Oven and Store. This interface is not required
 * to be implemented for this exercise.
 */
public interface Product {

	/**
	 * The size that this product physically occupies in cm2 ​@return ​
	 */
	double size();
